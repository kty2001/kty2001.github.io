...
def main():
    ...
    with st.expander('How to use Voice ChatBot', expanded=False):
        st.write(
            """
    ...
    system_prompt = '당신은 친절한 챗봇이다. 사용자 질문에 50단어 이내로 간결하게 답변하라.'
    ...
    with col1:
        ...
        st.markdown('### 텍스트로 입력')
        typed_text = st.text_input('질문 입력', value='', placeholder='Ex) 오늘 저녁 뭐 먹지')
